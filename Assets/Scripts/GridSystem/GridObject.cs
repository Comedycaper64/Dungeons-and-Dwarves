...
public class GridObject
{
   ...
   public GridObject(GridSystem<GridObject> gridSystem, GridPosition gridPosition)  //Constructor
    ...
    public void SetBonePile(BonePile bonePile)
    {
    ...
    {
        if(bonePile && bonePile.GetBones() > 0)
        {
            return true;
        }
        else
    ...
    public void AddBones() => bonePile.AddBones();

    public void UseBone() => bonePile.RemoveBones();
